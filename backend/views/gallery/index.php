...
$status = [
    Gallery::STATUS_INACTIVE => "Неактивный",
    Gallery::STATUS_ACTIVE => "Активный",
];

$this->title = 'Galleries';
$this->params['breadcrumbs'][] = $this->title;
?>
<?= Html::beginForm(['/gallery/index'], 'post'); ?>
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            'attribute' => 'file_id',
                            'label' => 'Image',
                            'headerOptions' => ['style' => 'width:280px;text-align:center'],
                            'contentOptions' => ['style' => 'text-align:center'],
                            'format' => 'raw',
                        ...
                        [
                            'attribute' => 'status',
                            'filter' => [Gallery::STATUS_ACTIVE => "Active", Gallery::STATUS_INACTIVE => "Inactive"],
                            'headerOptions' => ['style' => ''],
                        ...
                        [
                            ...
                            'buttons' => [
                                'buttons' => function ($url, $model) {
                                    $update = Url::to(['/gallery/update', 'id' => $model->id]);
                                    $delete = Url::to(['/gallery/delete', 'id' => $model->id]);
                                    $code = <<<BUTTONS
                            <div>
