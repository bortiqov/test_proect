 ...
 */
class FileUploadInline extends InputWidget
{
	/**
	 * @var
	 */
	 ...
	 * @var string
	 */
	public $mainView = 'inline/main';

	/**
	 * @var string
	 */
	public $uploadTemplateView = 'inline/upload';

	/**
	 * @var string
	 */
	public $downloadTemplateView = 'inline/download';
